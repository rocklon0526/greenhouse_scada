...
const RackNutrientTank3D: React.FC<{ data: RackNutrientTank }> = ({ data }) => {
  ...
  return (
    ...
    >
      ...
      {/* 2. 紅色主供水管 */}
      <mesh position={[-17, 2.5, 3]} rotation={[0, 0, Math.PI / 2]}>
        <cylinderGeometry args={[0.15, 0.15, 55, 16]} /> 
      ...
      <Html position={[0, 1.2, 0]} center style={{ pointerEvents: 'none' }} zIndexRange={[100, 0]}>
         <div 
