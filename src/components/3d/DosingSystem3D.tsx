    ...
    <group position={[baseX, 0, baseZ]}>
      ...
      <group position={[0, -2.5, 0]}>
        ...
        <group position={[0, -1.5, (mainPipeZ - baseZ) / 2]}> 
           <mesh rotation={[Math.PI/2, 0, 0]}><cylinderGeometry args={[0.3, 0.3, mainPipeZ - baseZ, 16]} /><meshStandardMaterial color={mainPipeColor} metalness={0.5} roughness={0.2} /></mesh>
        </group>
